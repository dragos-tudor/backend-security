...
partial class AuthenticationFuncs
{
  ...
  public static async Task<JsonDocument> ReadHttpResponseJsonResponse(HttpResponseMessage response, CancellationToken cancellationToken = default) => Parse(await ReadHttpResponseContent(response, cancellationToken));
}