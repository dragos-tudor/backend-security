...
import { getErrorJsonResponse, getJsonResponse } from "/www/testing.js"
...
Deno.test("fetch api", async t =>
{
  ...
  {
    const fetch = getFetchApi(() => Promise.resolve(getJsonResponse({val: 1})), _, _)
  ...
  await t.step("ok request => fetch api => no navigation", async () =>
  {
    ...
    const fetch = getFetchApi(() => Promise.resolve(getJsonResponse()), navigationSpy, _)
    await fetch("", {})
  ...
  {
    const navigationSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(401)), navigationSpy, _, {pathname: "/home"})
    await fetch("", {})
  ...
  {
    const navigationSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(401)), navigationSpy, _, {pathname: "/"})
    await fetch("", {})
  ...
  {
    const navigationSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(401)), navigationSpy, _, {pathname: "/login"})
    await fetch("", {})
  ...
  {
    const navigationSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(403)), navigationSpy, _)
    await fetch("", {})
  ...
  {
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(400)), _, _)
  ...
  {
    const handleSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(400)), _, handleSpy)
    const [, error] = await fetch("", {})
  ...
  {
    const navigationSpy = spy(() => {})
    const fetch = getFetchApi(() => Promise.resolve(getErrorJsonResponse(400)), navigationSpy, _)
    await fetch("", {})
