...
partial class OAuthTests {
  ...
  [TestMethod]
  public void Authentication_options_with_authorization_endpoint__authorize_challenge__authorization_path_is_authorization_endpoint () {
  ...
  [TestMethod]
  public void Authentication_options_with_scope__authorize_challenge__authorization_query_contains_scope_param () {
    var context = CreateHttpContext();
  ...
  [TestMethod]
  public void Authentication_options_with_client_id__authorize_challenge__authorization_query_contains_client_id_param () {
    var context = CreateHttpContext();
  ...
  [TestMethod]
  public void Authentication_options_with_callback_path__authorize_challenge__authorization_query_contains_redirect_uri_param () {
  ...
  [TestMethod]
  public void Authentication_options_using_pkce__authorize_challenge__authorization_query_contains_code_challenge () {
    var context = CreateHttpContext(new Uri("http://localhost"));
