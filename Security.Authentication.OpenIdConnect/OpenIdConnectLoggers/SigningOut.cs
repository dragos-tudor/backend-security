...
partial class OpenIdConnectFuncs
{
  ...
  [LoggerMessage(33, LogLevel.Information, "AuthenticationScheme: {SchemeName} is callback sign out. Redirect to: {RedirectUri}. [{RequestId}].", EventName = "SignOutCallback")]
